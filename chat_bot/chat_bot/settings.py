...
SECRET_KEY = 'django-insecure-v8l_nc77rzmue_5(pxz)k%!s((@hx7)&5o$)@lbm)9glygaw+a'
...
INSTALLED_APPS = [
    ...
    'chatbot',
    'bot',
    # all-auth libreria de autenticacion con google
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # Cambia si usas MySQL u otro
